...
#' (1) A list of information for the move. This has two fields. The first is a 
...
#' location. 
#' (3) A vector giving the positions of the two tourists (elements 1 and 2) and yourself (element 3). 
...
#' (4) a two column matrix giving the edges paths between waterholes (edges) present 
#' (the numbers are from and to numbers for the waterholes). 
#' All edges can be crossed both ways, so are only given once.
#' (5) a list of three matrices giving the mean and standard deviation of readings 
